...
//=========  (Sat Jul 18 02:19:45 2020) by ROOT version 6.18/04
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",1,1,600,576);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   Canvas_1->SetHighLightColor(2);
   Canvas_1->Range(-3.663158,-0.008227848,2.652632,0.05506329);
   ...
   glb_sta_eta_v_ptRes_0_sigma__304->SetMaximum(0.05);
   ...
   glb_sta_eta_v_ptRes_1_sigma__305->SetMaximum(0.05);
   ...
   glb_sta_eta_v_ptRes_2_sigma__306->SetMaximum(0.05);
